...
export default function NavBar() {
  return (
    <nav className="text-white flex justify-between p-5  items-center w-full gap-6 md:gap-2 fixed bg-black z-50">
      <div className="max-w-[200px] w-full hidden lg:block">
    ...
    <Link
       href="/waitlist"
      className="rounded-3xl bg-white flex justify-between items-center border border-white text-black gap-2 max-w-[228px] py-1 lg:py-3 px-5 transition duration-300 ease-in-out transform hover:bg-black hover:text-white"
    >
